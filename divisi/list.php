          ...
          <div class="card shadow">
            ...
            <div class="table-responsive">
              ...
              <table id="tb_divisi" class="table align-items-center table-flush">
                ...
                <tbody>
               	<?php
                $sql = "SELECT kode_divisi, nama_divisi FROM tb_divisi";
                ...
                ?>
                  <tr>
                    ...
                    <td><a href="<?=$link?>divisi/form.php?id=<?=$row['kode_divisi']?>" class="btn btn-primary btn-sm"><i class="fa fa-pen"></i> EDIT</a></td>
                  </tr>
                <?php 
                    endwhile;
                endif;
