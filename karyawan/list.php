          ...
          <div class="card shadow">
            ...
            <div class="table-responsive">
              ...
              <table id="tb_karyawan" class="table align-items-center table-flush">
                ...
                <tbody>
               	<?php
                $sql = "SELECT kode_karyawan, nama_karyawan, nama_divisi, jenis_kelamin FROM tb_karyawan JOIN tb_divisi ON tb_karyawan.kode_divisi=tb_divisi.kode_divisi";
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <a href="<?=$link?>karyawan/form.php?id=<?=$row['kode_karyawan']?>" class="btn btn-primary btn-sm"><i class="fa fa-pen"></i> EDIT</a>
                      <a href="<?=$link?>karyawan/lihat.php?id=<?=$row['kode_karyawan']?>" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i> LIHAT</a>
                    </td>
                  </tr>
                <?php 
                    endwhile;
