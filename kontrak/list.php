          ...
          <div class="card shadow">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Daftar Kontrak Karyawan</h3>
                </div>
            ...
            <div class="table-responsive">
              ...
              <table id="tb_divisi" class="table align-items-center table-flush">
                ...
                <tbody>
               	<?php
                $sql = "SELECT id, nama_karyawan, status, mulai_kerja, selesai_kerja, lama_kontrak FROM tb_kontrak JOIN tb_karyawan ON tb_kontrak.kode_karyawan=tb_karyawan.kode_karyawan";
                ...
                ?>
                  <tr>
                    ...
                    <td><a href="<?=$link?>kontrak/form.php?id=<?=$row['id']?>" class="btn btn-primary btn-sm"><i class="fa fa-pen"></i> EDIT</a></td>
                  </tr>
                <?php 
                    endwhile;
                endif;
